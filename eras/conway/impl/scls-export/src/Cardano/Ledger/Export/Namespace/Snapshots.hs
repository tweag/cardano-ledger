...
module Cardano.Ledger.Export.Namespace.Snapshots
  ( SnapShotIn(..)
  , SnapShotOut(..)
  , SnapShotValueType(..)
  , SnapshotStage(..)
...
deriving via (LedgerCBOR v PoolMetadata) instance ToCanonicalCBOR v PoolMetadata
...
type instance NamespaceKeySize "snapshots/v0" = 32
