...
instance Arbitrary CanonicalCoin where
    arbitrary = CanonicalCoin . getPositive <$> arbitrary

instance Arbitrary Proposals.V0.CanonicalVote where
...
instance Arbitrary Committee.V0.CanonicalCommitteeState where
    arbitrary = genericArbitraryU

instance Arbitrary (CanonicalCredential kr) where
    arbitrary = fmap mkCanonicalCredential arbitrary

instance Arbitrary Constitution.V0.CanonicalConstitution where
    arbitrary = genericArbitraryU

instance Arbitrary PParams.V0.CanonicalCostModels where
    arbitrary = genericArbitraryU

instance Arbitrary PParams.V0.CanonicalDRepVotingThresholds where
    arbitrary = genericArbitraryU

instance Arbitrary PParams.V0.CanonicalPoolVotingThresholds where
    arbitrary = genericArbitraryU

instance Arbitrary PParams.V0.CanonicalExUnits where
    arbitrary = genericArbitraryU

instance Arbitrary PParams.V0.CanonicalPrices where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalGovActionState where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalProposalProcedure where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalGovAction where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalGovActionId where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalGovActionIx where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalPurposeId where
    arbitrary = genericArbitraryU

instance Arbitrary Proposals.V0.CanonicalPParamsUpdate where
    arbitrary = genericArbitraryU
...
instance Arbitrary PoolStake.V0.PoolStakeOut where
    arbitrary = genericArbitraryU
...
instance Arbitrary UTxO.V0.CanonicalValue where
    arbitrary = do
        ...
        let m1 = Map.map (\innerMap -> Map.fromList
