...
module Cardano.Ledger.SCLS.Namespace.GovPParams.V0 (
  ...
  IsCanonicalDRepVotingThresholds (..),
  CanonicalPoolVotingThresholds (..),
  IsCanonicalPoolVotingThresholds (..),
  CanonicalExUnits (..),
  mkCanonicalExUnits,
...
class IsCanonicalPoolVotingThresholds a where
...
class IsCanonicalDRepVotingThresholds a where
  mkCanonicalDRepVotingThresholds :: a -> CanonicalDRepVotingThresholds
  fromCanonicalDRepVotingThresholds :: CanonicalDRepVotingThresholds -> a
...
data CanonicalPParams = CanonicalPParams
  ...
  , ccppTxFeePerByte :: CanonicalCoin
  , ccppTxFeeFixed :: CanonicalCoin
  , ccppMaxBBSize :: Word32
  , ccppMaxTxSize :: Word32
  , ccppMaxBHSize :: Word16
  , ccppKeyDeposit :: CanonicalCoin
  , ccppPoolDeposit :: CanonicalCoin
  , ccppEMax :: EpochInterval
  , ccppNOpt :: Word16
  , ccppRho :: UnitInterval
  , ccppTau :: UnitInterval
  , ccppProtocolVersion :: ProtVer
  , ccppMinPoolCost :: CanonicalCoin
  , ccppCoinsPerUTxOByte :: CanonicalCoin
  ...
  , ccppGovActionDeposit :: CanonicalCoin
  , ccppDRepDeposit :: CanonicalCoin
